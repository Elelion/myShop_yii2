...
// NOTE: copy from category\view and fixed
?>
            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items"><!--features_items-->
                    ...
                    <h2 class="title text-center">
                        Your search query: <?= Html::encode($q); ?>
                    </h2>
                    ...
                    <?php if (!empty($products)): ?>
                        ...
                        <?php foreach($products as $product): ?>
                            ...
                            /*
                             * NOTE:
                             * increasing the counter after each product call
                             * if i is divisible by 3 without remainder, i.e. if 3 blocks were output
                             * clearfix - resets the vertical. Ie aligns the blocks
                             * */
                            ?>
                            <?php $i++; ?>
                            <?php if ($i % 3 == 0): ?>
